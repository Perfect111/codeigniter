<div class="modal fade" id="addKeywordPopupFromList" tabindex="-1" role="dialog" aria-labelledby="Add service" aria-hidden="true">
              ...
              ?>
                <optgroup data label="<?php echo $key_array[1]; ?>">
                  <?php foreach($all_sub_cat as $cat): ?>
                    <option data-main-cat-id='<?php echo $key_array[0]; ?>' value="<?php echo $cat['id']; ?>"
                      <?php if($cat['id'] == $root_cat_id) echo "selected" ?>
                      >
