<div class="modal fade" id="addSubcategoryPopup" tabindex="-1" role="dialog" aria-labelledby="Add subcategory" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
        ...
        <?php if(count($main_category) > 0): ?>
          <?php foreach ($main_category as $cat): ?>
              <option <?php if($cat['id'] == $root_cat_id) echo "selected" ?> value="<?php echo $cat['id'] ?>"><?php echo $cat['name'] ?></option>
          <?php endforeach; ?>
        <?php endif; ?>
      </select>
      </div>
      ...
      <div class="modal-footer vd_bg-white">      
        <button type="button" class="btn btn-primary btn_add_sub_cat_from_popup" 
        >Save</button>
      </div>
    </div>
  </div>
