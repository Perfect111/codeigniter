<div class="modal fade blockjob" id="blockThisJob<?php echo $job_id?>" tabindex="-1" role="dialog" aria-labelledby="Add maincategory" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="company_id" id="company_id" class="form-control" value = "<?php echo $company_id?>" />
		  ...
		  <button type="submit" class="btn btn-primary btn-add-block">OK</button>
		</form>
      </div>	  
