<div class="modal fade denyjob" id="denyThisJob<?php echo $job_id?>" tabindex="-1" role="dialog" aria-labelledby="Add maincategory" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header vd_bg-green">
        ...
        <h4 class="modal-title vd_white">DENY THIS JOB</h4>
      </div>
      <div class="modal-body">
        ...
        <input type="hidden" name="company_id" id="company_id" class="form-control" value = "<?php echo $company_id?>" />
		  ...
		  <button type="submit" class="btn btn-primary btn-add-deny">OK</button>
		</form>
      </div>	  
