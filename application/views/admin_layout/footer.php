...
<!-- Common Modal Pop Up container -->
<div id="common_popup_container">
...
<!-- Placed at the end of the document so the pages load faster -->
	...
	<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js"></script>

<!--[if lt IE 9]>
  <script type="text/javascript" src="js/excanvas.js"></script>
<![endif]-->
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>js/bootstrap.min.js"></script>
<script type="text/javascript" src='<?php echo $this->assets_uri; ?>plugins/jquery-ui/jquery-ui.custom.min.js'></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>

<script type="text/javascript" src="<?php echo $this->assets_uri; ?>js/caroufredsel.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>js/plugins.js"></script>

<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/breakpoints/breakpoints.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/dataTables/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/prettyPhoto-plugin/js/jquery.prettyPhoto.js"></script>

<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/tagsInput/jquery.tagsinput.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/bootstrap-switch/bootstrap-switch.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/blockUI/jquery.blockUI.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/pnotify/js/jquery.pnotify.min.js"></script>

<script type="text/javascript" src="<?php echo $this->assets_uri; ?>js/theme.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>custom/custom.js"></script>

<!-- Specific Page Scripts Put Here -->
<!-- Flot Chart  -->
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/flot/jquery.flot.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/flot/jquery.flot.resize.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/flot/jquery.flot.pie.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/flot/jquery.flot.categories.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/flot/jquery.flot.time.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/flot/jquery.flot.animator.min.js"></script>

<!-- Vector Map -->
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script type="text/javascript" src="<?php echo $this->assets_uri; ?>plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- Calendar -->
<script type="text/javascript" src='<?php echo $this->assets_uri; ?>plugins/moment/moment.min.js'></script>
<script type="text/javascript" src='<?php echo $this->assets_uri; ?>plugins/jquery-ui/jquery-ui.custom.min.js'></script>
<script type="text/javascript" src='<?php echo $this->assets_uri; ?>plugins/fullcalendar/fullcalendar.min.js'></script>

<!-- Intro JS (Tour) -->
<script type="text/javascript" src='<?php echo $this->assets_uri; ?>plugins/introjs/js/intro.min.js'></script>
