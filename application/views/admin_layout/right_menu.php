<div class="vd_navbar vd_nav-width vd_navbar-chat vd_bg-black-80 vd_navbar-right scrolled-comments">
		<div class="navbar-tabs-menu clearfix">
			<span class="expand-menu" data-action="expand-navbar-tabs-menu">
				<span class="menu-icon menu-icon-left">
					<i class="fa fa-ellipsis-h"></i><span class="badge vd_bg-red">20</span>
				</span>
			...
			<div class="menu-container">
				<div class="navbar-search-wrapper">
					...
					</div><!-- navbar-search end -->
				</div><!-- navbar-search-wrapper end -->
				...
				<ul class="list-wrapper no-bd-btm pd-lr-10">
					...
					<li>
						<a href="#">
							...
							src="<?php echo $this->assets_uri; ?>img/avatar/avatar.jpg" alt="example image"></div>
					...
					<li>
						<a href="#">
							<div class="menu-icon">
							<img src="<?php echo $this->assets_uri; ?>img/avatar/avatar-2.jpg" alt="example image"></div>
					...
					<li>
						<a href="#">
							<div class="menu-icon">
							<img src="<?php echo $this->assets_uri; ?>img/avatar/avatar-3.jpg" alt="example image"></div>
					...
					<li>
						<a href="#">
							<div class="menu-icon">
							<img src="<?php echo $this->assets_uri; ?>img/avatar/avatar-4.jpg" alt="example image"></div>
					...
					<li>
						<a href="#">
							<div class="menu-icon">
							<img src="<?php echo $this->assets_uri; ?>img/avatar/avatar-5.jpg" alt="example image"></div>
							<div class="menu-text">Stefanie Imburgh
								<div class="menu-info"><span class="menu-date">Dancer</span></div>
							</div>
					...
					<li>
						<a href="#">
							<div class="menu-icon">
							<img src="<?php echo $this->assets_uri; ?>img/avatar/avatar-6.jpg" alt="example image"></div>
							<div class="menu-text">Matt Demon
								<div class="menu-info"><span class="menu-date">Musician</span></div>
							</div>
							<div class="menu-badge"><span class="vd_grey font-sm"><i class="fa fa-mobile"></i></span></div>
						</a>
					</li>
					<li>
						<a href="#">
							<div class="menu-icon">
							<img src="<?php echo $this->assets_uri; ?>img/avatar/avatar-7.jpg" alt="example image"></div>
							<div class="menu-text">Jeniffer Anastasia
								<div class="menu-info"><span class="menu-date">Senior Developer</span></div>
							</div>
							<div class="menu-badge"><span class="badge status vd_bg-green">&nbsp;</span></div>
						</a>
					</li>
					<li>
						<a href="#">
							<div class="menu-icon">
							<img src="<?php echo $this->assets_uri; ?>img/avatar/avatar-8.jpg" alt="example image"></div>
							<div class="menu-text">Daniel Dreamon
								<div class="menu-info"><span class="menu-date">Sales Executive</span></div>
							</div>
							<div class="menu-badge"><span class="badge status vd_bg-green">&nbsp;</span></div>
						</a>
					</li>
